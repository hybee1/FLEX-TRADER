...
* The original package name 'com.synogiestechnologies.flex-trader-discovery-service' is invalid and this project uses 'com.synogiestechnologies.flex_trader_discovery_service' instead.
