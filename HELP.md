...
* The original package name 'com.synogiestechnologies.flex-trader-config-server' is invalid and this project uses 'com.synogiestechnologies.flex_trader_config_server' instead.
